    ...
    <div className="doc-tab">
      <div className="inhouse-team">
        ...
        <p className="document-para">
          Create a document list that are need to be uploaded by the client for
          the relevant product. Minumum document list is need to be added to
      ...
      <div className="inhouse-team">
        ...
        <p className="document-para">
          Create document list for the agent which are need to be uploaded for
          product history/ records. ( Visibility of internal documents can be
          hide)
        </p>
        <div className="add-document">
          <input className="upload-file" type="file" />
